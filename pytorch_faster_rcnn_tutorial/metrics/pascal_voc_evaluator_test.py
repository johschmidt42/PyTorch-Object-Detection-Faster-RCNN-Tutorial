...
gt_boxes = [
    from_file_to_boundingbox(file_name, groundtruth=True) for file_name in targets
]
# reduce list
gt_boxes = list(chain(*gt_boxes))
# TODO: add predictions
pred_boxes = [
    from_file_to_boundingbox(file_name, groundtruth=False) for file_name in targets
]
